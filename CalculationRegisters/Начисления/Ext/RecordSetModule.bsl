Процедура РассчитатьСуммуНачислений() Экспорт
	...
	Для Каждого Движение Из ЭтотОбъект Цикл
		...
		ИначеЕсли Движение.ВидРасчета = ПланыВидовРасчета.Начисления.Больничный Тогда
			...
			КоличествоДнейБолезни = (КонецДня(Движение.ПериодДействияКонец) + 1 - НачалоДня(Движение.ПериодДействияНачало)) / 86400;
